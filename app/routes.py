...
def initialize_routes(app):
    ...
    app.register_blueprint(interview_blueprint, url_prefix='/api/v1/interview')
    app.register_blueprint(job_blueprint, url_prefix='/api/v1/job')
    app.register_blueprint(candidate_blueprint, url_prefix='/api/v1/candidate')